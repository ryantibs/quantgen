...
dim(coef(obj)) # Matrix of dimension (p + 1) x (number of tau and lambda pairs)
dim(predict(obj, new=x0)) # Array of dimension (number of x0 points) x (number 
                          # of lambda values) x (number of tau values)
```
